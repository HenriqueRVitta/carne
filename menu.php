...
print "</head><body class='menu'>";
	...
	//Para compatibilizar os scripts da versï¿½o 1.40 na restauraï¿½ï¿½o da sessï¿½o
	...
	if (isset($_GET['LOAD']) && $_GET['LOAD'] == 'ADMIN'){//QUANDO A Pï¿½GINA FOR RECARREGADA PARA NOVO TEMA
		$where = TRANS('MNL_ADM');
		$menu="treemenu3";

...
$mpdf->SetHTMLFooter($footerE,'E');
	...
	while($row = mysql_fetch_array($resultado)){
		...
		$lcString.="<tr>
		  ...
		  <tr>
		    <td align='center' colspan='2'><div style='font-weight: bold; text-align: center; font-family: serif; font-size: 15pt; color: #000000;'>CARN&Ecirc; DE DOA&Ccedil;&Atilde;O MENSAL / PARCELAMENTO</div></td>
		  </tr>
		  <tr>
		    ...
		    <td align='left' height='48' width='500'><div style='text-align: left; font-family: serif; font-size: 18pt; color: #000000;'>Nome: ".$row['nometitular']."</div></td>
		  </tr>
		  <tr>
		    <td>&nbsp;</td>
		    <td width='120'>&nbsp;</td>

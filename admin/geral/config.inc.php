...
//Usuario do banco
define ( "SQL_USER", "carnepromedico"); // Usu�rio do Banco de Dados

//Senha do banco
define ( "SQL_PASSWD", "mcjuser@2017");// Senha do Banco de Dados
//Servidor do banco
define ( "SQL_SERVER", "carnepromedico.mysql.dbaas.com.br"); // IP ou nome Servidor

//Nome do banco
define ( "SQL_DB", "carnepromedico"); // Nome do Banco de Dados

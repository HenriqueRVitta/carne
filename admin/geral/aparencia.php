<?php 
  ...
  */session_start();
	...
	$auth->testa_user($_SESSION['s_usuario'],$_SESSION['s_nivel'],$_SESSION['s_nivel_desc'],1, 'helpconfiggeral.php');
    	...
    	print "<BR><B>".TRANS('TTL_APPEARANCE','Configura��es de apar�ncia do sistema').":</b><BR>";
	...
	if ((empty($_GET['action'])) and empty($_POST['submit'])){
		...
		print "<br><TD align='left'>".
				"<input type='button' class='button' id='idBtIncluir' value='".TRANS('BT_EDIT_CONFIG','Editar Configura��o',0)."' onClick=\"redirect('".$_SERVER['PHP_SELF']."?action=alter&cellStyle=true');\">".
			"</TD><br><BR>";
		...
		else
		{
				...
				print "<tr><td colspan='2'><b>".TRANS('OPT_APPEARANCE','APAR�NCIA')."</b></td></tr>";
				...
				print "<tr><td>".TRANS('COLOR_ODD_LINE','COR DAS LINHAS �MPARES').":</td><td>".
				...
				print "<tr><td>".TRANS('COLOR_LINE_SELECTION','COR DA SELE��O DE LINHAS').":</td><td>".
					...
					"</tr>";
				print "<tr><td>".TRANS('COLOR_LINE_MARK','COR DA MARCA��O DAS LINHAS').":</td><td>".
...
/*					"</tr>";		print "<tr><td>COR DO TD_COLOR:</td><td>".
				...
				print "<tr><td>".TRANS('COLOR_TABLE_HEADER','COR DOS CABE�ALHOS DAS TABELAS').":</td><td>".
				...
				print "<tr><td>".TRANS('COLOR_FONT_TABLE_HEADER','COR DA FONTE DOS CABE�ALHOS DAS TABELAS').":</td><td>".
...
/*			print "<tr><td>COR DO TD_COLOR:</td><td>".
		...
		print "<tr><td colspan='2'>&nbsp;</td></tr>";
		print "<tr><td colspan='2'><a class='href' onClick=\"loadAllDefaults();\" title='Carrega as cores padr�o!'>".TRANS('OPT_SELECT_DEFAULT_SQUEMA','SELECIONA O ESQUEMA DE CORES PADR�O')."</a></td>".
			"</tr>";
		print "<tr><td colspan='2'>&nbsp;</td></tr>";
		print "<tr><td colspan='2'><a class='href' onClick=\"varreCampos('form1')\">".TRANS('OPT_SAVE_SQUEMA','SALVAR SELE��O PARA ESQUEMA DE CORES')."</td></a>".
			"</tr>";
		print "<tr><td colspan='2'>&nbsp;</td></tr>";
	...
	if ($_POST['submit'] = TRANS('BT_ALTER')){
		...
		//print "<script>mensagem('Configura��o alterada com sucesso!'); window.open('../../index.php?LOAD=ADMIN','_parent',''); </script>";
		print "<script>mensagem('".TRANS('MSG_SUCCESS_CONFIG_SQUEMA','Configura��o alterada com sucesso!\\nO Esquema selecionado ser� carregado agora',0)."!'); window.open('../../index.php?LOAD=ADMIN','_parent',''); </script>";
...
<!--
	function valida(){
		...
		if (ok) var ok =  validaForm('idDestaca','COR','Cor de sele��o de linhas',1);
		if (ok) var ok =  validaForm('idMarca','COR','Cor de marca��o de linhas',1);

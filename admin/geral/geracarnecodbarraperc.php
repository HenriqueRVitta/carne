...
';
    ...
    $resultado = mysqli_query($query) or die('ERRO NA QUERY !'.$query);
	$i=0;
	$lntotalpg = 0.00;
	...
	For ($x=$MesIni; $x<=$MesFim; $x++) {
		...
		$codbarra = "9".strzero($row['nrocarne'],5).strzero($x,2).$ano;
		...
		<td height='25' align='center' style='text-align: center; font-family: serif; font-size: 13pt; color: #000000;'>Taxa:".number_format($row['percdesc'],0,",",".")."%</TD>
		<td height='25' align='center' style='text-align: center; font-family: serif; font-size: 13pt; color: #000000;'>Taxa:".number_format($row['percdesc'],0,",",".")."%</TD>
		<td height='25' align='center' style='text-align: center; font-family: serif; font-size: 13pt; color: #000000;'>Taxa:".number_format($row['percdesc'],0,",",".")."%</TD>
		</tr><tr>

...
*/
	...
	print "<BODY onLoad='document.tipodependente.idnome.focus();'bgcolor='".BODY_COLOR."'>";
	...
	print "<BR><B><font size=4>"."Administra&ccedil;&atilde;o Tipo de Dependente"."</font></B><BR>";

	print "<FORM name='tipodependente' method='POST' action='".$_SERVER['PHP_SELF']."' onSubmit=\"return valida()\">";
	...
	if ((!isset($_GET['action'])) && empty($_POST['submit'])) {
	    ...
	    if(liberamenu('Incluir Tipo Dependente')=="N"){
		...
		else
		{
			...
			print "</tr>";
			//------------------------------------------------------------- INICIO ALTERACAO --------------------------------------------------------------
			print "<TR class='header'><td class='line'>"."Descri&ccedil;&atilde;o"."</TD>"."<td class='line'>"."Idade m&aacute;xima"."</TD>"."<td class='line'>"."C&oacute;digo"."</TD>".
			...
			while ($row = mysql_fetch_array($PAGE->RESULT_SQL))
			{
				...
				print "<td class='line'>".$row['idademaxima']."</td>";
				...
				if(liberamenu('Excluir Tipo Dependente')=="N"){
	...
	if ((isset($_GET['action'])  && ($_GET['action'] == "incluir") )&& empty($_POST['submit'])) {
		...
		print "<BR><b><font size=2 color='blue'>"."Inclus&atilde;o Tipo Dependente"."</b></font><BR>";
		...
		print "<TD class='line'><a href='tipodependente.php'><img height='22' width='22' src='".ICONS_PATH."voltar.png' title='Voltar'></a></TD>";
		print "</TR><TR>";		
		print "<TD width='20%' align='left' bgcolor='".TD_COLOR."'>"."Descri&ccedil;&atilde;o".":</TD>";
		print "<TD width='20%' align='left' bgcolor='".BODY_COLOR."'><INPUT type='text' class='text3' name='nome' maxlength='45' id='idnome'></td>";
		print "</TR><TR>";		
		print "<TD width='20%' align='left' bgcolor='".TD_COLOR."'>"."Idade m&aacute;xima permitida".":</TD>";
		print "<TD width='20%' align='left' bgcolor='".BODY_COLOR."'><INPUT type='text' class='text4' name='idademaxima' maxlength='3' id='ididademaxima'></td>";
		print "</TR><TR>";		
	...
	if ((isset($_GET['action']) && $_GET['action']=="alter") && empty($_POST['submit'])) {
		...
		print "<BR><b><font size=2 color='blue'>"."Edi&ccedil;&atilde;o Tipo Dependente"."</b></font><BR>";		
		...
		print "</TR><TR>";		
		print "<TD width='20%' align='left' bgcolor='".TD_COLOR."'>"."Idade m&aacute;xima permitida".":</TD>";
		print "<TD width='20%' align='left' bgcolor='".BODY_COLOR."'><INPUT type='text' class='text4' name='idademaxima' maxlength='3' id='ididademaxima' value='".$row['idademaxima']."'></td>";
		
		print "</TR><TR>";

	    if(liberamenu('Alterar Tipo Dependente')=="N"){
	    	$disabled = " disabled='disabled'";
	    	$clasbutton = " class='buttonDisabled'";
	    }
	...
	if (isset($_GET['action']) && $_GET['action'] == "excluir"){
			$query2 = "DELETE FROM carne_tipodependente WHERE id='".$_GET['cod']."'";
	...
	if ((isset($_POST['submit'])  && ($_POST['submit'] == TRANS('BT_CAD')))) {	
		...
		$qryl = "SELECT * FROM carne_tipodependente WHERE descricao='".$_POST['nome']."'";
	...
	if ((isset($_POST['submit'])  && ($_POST['submit'] == TRANS('BT_ALTER')))) {	
		...
		$query2 = "UPDATE carne_tipodependente SET descricao='".$lcnome."', unidade=".$_SESSION['s_local'].", idademaxima='".$_POST['idademaxima']."' WHERE id=".$_POST['codigo']." ";		
...
<!--
	function valida(){
		...
		if (ok) var ok = validaForm('idnome','','Descrição',1);

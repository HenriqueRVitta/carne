...
*/
	...
	print "<BR><B><font size=4>"."Gerar Carn&ecirc; para Cobran&ccedil;a na rede Banc&aacute;ria"."</font></B><BR>";

	print "<FORM name='relgerarcarnebancario' method='POST' action='../carnebancario/carne_bancoob.php' target='_blank' onSubmit=\"return valida()\">";	
	...
	print "<TABLE border='0' align='left' ".$cellStyle."  width='80%' bgcolor='".BODY_COLOR."'>";
		...
		print "<TD align='left' width='20%' bgcolor='".BODY_COLOR."'><input type='submit' value='EMITIR CARN&Ecirc;' name='submit' >";

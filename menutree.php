...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en" xml:lang="en"><head><title>MyCSSMenu Save Document</title><meta http-equiv="Content-Type" content="text/html;charset=utf-8"/>
...
/*!!!!!!!!!!! MyCSSMenu Styles [Please Modify!] !!!!!!!!!!!*/
	...
	{	
		...
		background-image:url("includes/imgs/xptitle_s.gif");
		color:#000000;
		font-family:Arial;
		font-size:15px;
...
<style type="text/css">.qmfv{visibility:visible !important;}.qmfh{visibility:hidden !important;}</style><script type="text/JavaScript">var qmad = new Object();qmad.bvis="";qmad.bhide="";</script>
	...
	<script type="text/JavaScript">
		...
		a.ibullets_main_image = "includes/imgs/xpexpand1_s.gif";
		a.ibullets_main_image_hover = "includes/imgs/xpexpand1_s.gif";
		a.ibullets_main_image_active = "includes/imgs/xpcollapse1_s.gif";
		a.ibullets_main_image_width = 25;
		a.ibullets_main_image_height = 23;
		a.ibullets_main_position_x = -15;
		a.ibullets_main_position_y = -6;
		a.ibullets_main_align_x = "right";
		a.ibullets_main_align_y = "middle";
		a.ibullets_sub_image = "includes/imgs/open.png";
		a.ibullets_sub_image_hover = "includes/imgs/open.png";
		a.ibullets_sub_image_active = "includes/imgs/close.png";
...
<ul id="qm0" class="qmmc">
 	<li><a href='#'><span><h3>Op&ccedil;&otilde;es de Menu</h3></span></a></li>

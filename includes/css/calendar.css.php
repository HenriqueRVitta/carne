...
print "#calendarDiv{
	position:absolute;
	width:205px;
	border:1px solid #999999; ". //*#317082 - BORDA DA CAIXA DO CALEND�RIO*/
	"padding:1px;
	background-color: #FFF; ".//*#FFF - COR DE FUNDO DO CALEND�RIO*/
	"font-family:arial;
	font-size:10px;
	padding-bottom:20px;
	visibility:hidden;
...
print "#calendarDiv .monthYearPicker{
	background-color: #F0F0F0;". //*#E2EBED - FUNDO DA CAIXA DE SELE��O DESDOBRADA*/
	"border:1px solid #AAAAAA;". //*#AAAAAA - BORDA DA CAIXA DE SELE��O DO ANO E MES DESDOBRADA*/
	"position:absolute;
	color: #5E515B; ".//*#317082  - COR DO ANO E MES NA CAIXA DE SELE��O DESDOBRADA*/
	"left:0px;
	top:15px;
	z-index:1000;
	display:none;
...
print "#calendarDiv .monthYearActive{
	background-color:#DBDBDB; ".//*#317082 HOVER DA CAIXA DE SELE��O ANO-MES DESDOBRADA - FUNDO*/
	"color: black;". //*#E2EBED - HOVER DA CAIXA DE SELE��O ANO-MES DESDOBRADA - FONTE*/
"}";

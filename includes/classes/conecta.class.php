...
class conexao {
	...
	function conecta($BANCO){
		...
		$this->con=mysqli_connect(SQL_SERVER,SQL_USER,SQL_PASSWD) or die("N�o foi poss�vel conectar ao banco MySQL Error ".mysqli_errno($this->con)." ".mysqli_error($this->con));
		$this->db=mysqli_select_db($this->con,SQL_DB) or die("<h1>Erro de conex�o com o Banco de Dados >> ".SQL_DB." </h1><br><h2>Verifique o se o nome e o caminho do Banco de dados est�o corretos nas configura��es...</h2>");
